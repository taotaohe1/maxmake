...
### Solutions
1. Check if the motor driver signal wires are loose and try reconnecting them. For cover removal steps, refer to the video for replacing the main control board [HiMill D1S Replace Air Cabinet Components](/eng/himill-d1-d1s/hmd1s-replace-air-cabinet.md)
<img src="/eng/himill-d1-d1s/media/hmd1s-spindle-issue/主控未插线电机驱动.jpg" alt="Control board without motor driver wires" style="width: 350px; height: auto; margin-bottom: 8px; border-radius: 16px;" /> <img src="/eng/himill-d1-d1s/media/hmd1s-spindle-issue/电机驱动.jpg" alt="Control board with motor driver wires" style="width: 450px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
