...
- **Zt/Zb Parameter Settings**：
  ...
  <img src="/eng/himill-d1-d1s/media/hmd1s-height-map/zt_zb_setting.webp" alt="Zt and Zb parameter settings diagram" style="width: 400px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
