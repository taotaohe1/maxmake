...
<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/4-加工安全-2-打开安全门会暂停加工.webp" alt="Safety Door 2" style="width: 600px; height: auto; margin-bottom: 8px; border-radius: 16px;" />

<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/4-加工安全-3-恢复加工.webp" alt="Safety Door 3" style="width: 600px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/4-加工安全-5.webp" alt="Spindle Handle" style="width: 600px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
