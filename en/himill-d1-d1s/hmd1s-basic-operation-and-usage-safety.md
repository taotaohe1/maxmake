...
<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/3-装夹安全-1.webp" alt="Fixture Types" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/3-装夹安全-2.webp" alt="Proper Clamping" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/4-加工安全-2-打开安全门会暂停加工.webp" alt="Safety Door 2" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />

<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/4-加工安全-3-恢复加工.webp" alt="Safety Door 3" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/4-加工安全-4.webp" alt="No Gloves" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />

### 4. Spindle Operation
When the spindle is rotating, do not pull the handle, as this may cause spindle damage.

<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/4-加工安全-5.webp" alt="Spindle Handle" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/basic-operation-and-usage-safety/5-严禁带电拆机.webp" alt="Power Off Operation" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
