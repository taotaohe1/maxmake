...
Due to the relatively high height of the rotation axis itself, the spindle may need to be raised. Loosen the 3 fixing screws of the spindle, move it up, and then refix it.

<img src="/eng/himill-d1-d1s/media/hmd1-rotation-axis-processing/1-上调主轴.webp" alt="Raise Spindle" style="width: 600px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
