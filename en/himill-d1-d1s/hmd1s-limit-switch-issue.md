...
5. Check if the limit switch connection wires are loose and try reconnecting them. For details, refer to the video on replacing XY limits [HiMill D1S Limit Switch Replacement](/en/himill-d1-d1s/hmd1s-replace-limit-switch.md)
6. Check if the limit connection terminals on the main control board are connected properly and try reconnecting them. For cover removal steps, refer to the video for replacing the main control board [HiMill D1S Replace Air Cabinet Components](/en/himill-d1-d1s/hmd1s-replace-air-cabinet.md)
