...
### Manual Update
For detailed instructions, please refer to: [MaxmakeLab HiMill D1/D1S Firmware Upgrade](/en/himill-d1-d1s/hmd1s-firmware-upgrade.md)
...
> - Do not turn off the device or disconnect during update
...
#### 🎉 Official Release
- Initial firmware version release for HiMill D1S
- Support for basic CNC processing functions
- Support for laser processing functions
- Support for USB and WiFi connections