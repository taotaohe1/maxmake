...
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-录屏-主轴向右移动.webp" alt="Spindle moving right" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-拍摄-主轴向右移动.webp" alt="Spindle moving right" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />  

<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-录屏-主轴向左移动.webp" alt="Spindle moving left" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-拍摄-主轴向左移动.webp" alt="Spindle moving left" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />

### 2. Y-axis Movement Control

Click this button to control Y-axis front and back movement.

<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-录屏-垫板向内移动.webp" alt="Base plate moving inward" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-拍摄-垫板向内移动.webp" alt="Base plate moving inward" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />  

<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-录屏-垫板向外移动.webp" alt="Base plate moving outward" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-拍摄-垫板向外移动.webp" alt="Base plate moving outward" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />  
...
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-录屏-主轴向下移动.webp" alt="Spindle moving down" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-拍摄-主轴向下移动.webp" alt="Spindle moving down" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />  

<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-录屏-主轴向上移动.webp" alt="Spindle moving up" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/1-移动操作-拍摄-主轴向上移动.webp" alt="Spindle moving up" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/3-设置步距和进给率.webp" alt="Step size and feed rate settings" style="width: 500px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/5-2-激光移动界面截图.webp" alt="Laser movement interface" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/5-3-快速移动.webp" alt="Quick movement positioning" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
...
<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/5-4-激光激活+边框定位.webp" alt="Laser activation + border positioning" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />  

<img src="/eng/himill-d1-d1s/media/hmd1s-movement-and-positioning/5-5-拍摄边框定位.webp" alt="Border positioning effect" style="width: 800px; height: auto; margin-bottom: 8px; border-radius: 16px;" />
