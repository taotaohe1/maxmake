...
> ⚠️ **紧急更新提示**：
> 由于3D测头可能因G代码问题出现错误移动，我们已添加新代码来保护3D测头。请使用以下0.9.16先行版（仅Windows版本）以获得更好的3D测头保护。
> {.is-warning}

### 0.9.16先行版 (仅Windows版本)
**[MaxmakeLab 0.9.16先行版下载链接](https://drive.google.com/drive/folders/1Gb-SWAFe8RE6lq0btQwnII0xnihwDA6Z?usp=sharing)**
