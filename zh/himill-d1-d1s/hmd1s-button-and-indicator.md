# HiMill D1/D1S 按键和指示灯

本文档详细介绍HiMill D1/D1S设备上按键和指示灯的功能及操作方法，帮助用户了解设备状态和正确操作。
...
> 📋 **状态说明**：
> 
> 设备开机后显示彩虹变换指示灯，表示需要先执行回零操作才能开始使用。
> 
> {.is-info}

> ⚙️ **操作方法**：
> 
> 在软件中点击"回零"按钮，等待设备完成自动归零。
> 
> {.is-info}
...
> 📋 **状态说明**：
> 
> 设备完成回零后显示蓝色呼吸指示灯，表示设备处于空闲状态，可以接收和执行加工指令。
> 
> {.is-info}
...
> 📋 **状态说明**：
> 
> 设备显示红色呼吸指示灯，表示设备处于报警状态，可能需要重新回零或手动解锁。
> 
> {.is-info}

> ⚙️ **操作方法**：
> 
> 检查设备是否在安全位置，重新执行回零操作，或在软件中点击解锁按钮。
> 
> {.is-info}
...
> 📋 **状态说明**：
> 
> 文件上传成功，设备显示彩色旋转指示灯，表示可以开始加工。
> 
> {.is-info}

> ⚙️ **操作方法**：
> 
> 确认工件装夹牢固后，按住按键2秒开始加工。
> 
> {.is-info}
