...
> ⚠️ **安装注意事项**：
> 
> - 因考虑到加工时避免共振带来的噪音，支架设计的非常贴合，安装时可能比较紧
> - 可先装入一半，剩下部分可借助主轴背板，贴紧背板，从前向后按压主轴，将支架挤入槽位
> 
> {.is-warning}
...
> - 请务必确保连接线朝向正确方向
> 
> 🔄 **回零检查**：安装完成后，建议进行一次完整的回零操作测试
> 
> ⚡ **故障排除**：如果回零失败，首先检查连接线方向是否正确
> {.is-danger}