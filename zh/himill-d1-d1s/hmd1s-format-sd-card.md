# MaxmakeLab HiMill D1/D1S 格式化SD卡

## 📋 为什么需要格式化SD卡

设备加工时，文件会传输到设备的Micro SD卡中。如果文件传输总是失败，可能是SD卡出现问题，可以尝试格式化SD卡来解决。

## ⚠️ 注意事项

> **重要提醒**：格式化过程中请勿断电或断开USB连接线，否则可能导致设备故障或SD卡损坏。
>
> {.is-warning}
